...
<table data-column-title-hidden data-view="cards">
  ...
  <tbody>
    ...
    <tr><td><h2>Multithreaded Network File Server</h2></td><td><p>⋅ ⋅ ⋅ ⋅ ⋅</p><p>A crash-consistent network file server that supports multiple users and nested directories and file</p></td><td><em>C++, Operating Systems, Project</em></td><td><a href="class-project-descriptions/multithreaded-network-server.md">multithreaded-network-server</a></td></tr>
